...
const Register = () => {
  ...
  const manageRegistration = (data) => {
    console.log(data);
    handleSignUpWithEmailPass(data.email, data.pass).then((user) => {
      console.log(user);
      updateUsersProfile(data.name, data.pictureUrl).then((res) => {
        console.log(res);
        Swal.fire({
          icon: "success",
  ...
  return (
    <div className=" w-full my-8">
      <div className="min-w-screen min-h-screen flex items-center justify-center px-5 md:py-5">
        <div
          className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden"
          style={{ maxWidth: "1000px" }}
        >
          <div className="md:flex w-full">
            <div className="hidden md:block w-1/2 bg-indigo-500 md:py-10 px-10">
              <svg
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
              ...
              <div className="flex items-center flex-col ">
                <form onSubmit={handleSubmit(manageRegistration)}>
                    ...
                    <div className="md:w-1/2 px-3 mb-3">
                      ...
                      <div className="flex">
                        ...
                        <input required
                          {...register("email")}
                          type="email"
                          className="w-full -ml-10 pl-3 pr-2 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                ...
                <Button
                  ...
                  className="text-center gap-2 flex justify-center items-center self-center"
                >
